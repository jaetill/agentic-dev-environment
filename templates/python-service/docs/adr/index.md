...
- **Always**: any change in one of the 5 ADR-gated categories (per platform ADR-0003): destructive DB migration, new external dep/service, security-relevant change, API contract change, schema change.
