...
- **Scope cap.** A PR may not exceed **50 lines of production code, 3 source files, or 1 component**. Over the cap, the implementer refuses and asks the architect to decompose. (Tests and docs don't count toward the LOC cap.)
...
- The scope cap refuses larger work, pushing it back to the architect for decomposition — friction by design.
